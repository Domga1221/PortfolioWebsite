        ...
        lg:max-w-7xl mx-auto relative z-10">
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
                <div class="flex flex-col md:mt-0 mt-20 justify-center">
                    ...
                    data-aos="fade-right"
                    >
                    <h1 class="text-white font-bold text-4x1
                    ...
                    data-aos="fade-right"
                    data-aos-delay="100">
                        Computer Scientist (B. Sc.) & Art Enthusiast
                    </p>
                    </div>
...
<script setup>
import { ArrowDownTrayIcon, ArrowRightIcon, FolderArrowDownIcon } from '@heroicons/vue/16/solid';
