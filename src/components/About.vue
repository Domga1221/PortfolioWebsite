            ...
            items-center">
                ...
                <div class="relative w-full max-w-md">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="rounded-xl p-2 border shadow-lg"
                        ...
                        rounded-xl group-hover:scale-105 
                    ...
                    >
                        ...
                        <div class="text-center text-white text-xl font-bold">3+ Years Experience</div>
                    </div>
                    </div>
                </div>
...
<script setup>
import { ArrowRightIcon, ChatBubbleLeftRightIcon, CodeBracketSquareIcon, 
    CubeIcon, PaintBrushIcon, ServerIcon } 
